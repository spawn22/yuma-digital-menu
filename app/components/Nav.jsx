...
const Nav = () => {
  return (
    ...
    <div className="flex"><Image  alt="logo de YUMA" priority={true}  className="w-52 h-20  top-0 " src={logoNav} /></div>
            ...
            <div className="w-6 h-[0px] left-4 top-6 absolute shadow-sm border-2 border-amber-400"></div>
            <div className="w-6 h-[0px] left-4 top-9 absolute shadow-sm border-2 border-amber-400"></div>
            <div className="w-6 h-[0px] left-4 top-12 absolute shadow-sm border-2 border-amber-400"></div>
            </div>
